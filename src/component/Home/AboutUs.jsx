...
const AboutUs = () => {
  ...
  return (
    <section className="xl:max-w-10/12 max-lg:container mx-auto my-24 mt-12 p-6 rounded flex flex-col lg:flex-row xl:gap-20 lg:gap-0 gap-20 overflow-x-hidden">
      <motion.div
        ref={ref}
      ...
      <motion.div
        ...
        className="my-auto"
      >
        <h3 className="md:text-lg xl:text-2xl text-black/60 font-medium mb-4">
          About Us &mdash;
        </h3>
        <h3 className="text-xl sm:text-2xl md:text-3xl xl:text-4xl text-black/80 font-bold mb-4">
          Study. Collaborate. Grow Together.
        </h3>
        <p className="md:text-lg lg:text-base xl:text-lg text-gray-700 mb-6">
        ...
        <ul className="list-disc pl-6 md:text-lg lg:text-base xl:text-lg text-gray-700 mb-6">
        ...
        <button className="btn md:btn-lg xl:btn-xl bg-main text-white px-6 py-2 rounded hover:bg-main/80 transition duration-300 ">
          Join Us Now
        </button>
      </motion.div>
    </section>
